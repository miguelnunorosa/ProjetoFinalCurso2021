...
<script src="{{ asset('vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script><!-- Bootstrap -->
<script src="{{ asset('vendor/adminlte/js/adminlte.min.js') }}"></script><!-- AdminLTE -->


<!-- DataTables -->
<script src="{{asset('vendor/datatables/datatables/jquery.dataTables.js')}}"></script>
...
<script src="{{asset('vendor/datatables/datatables-buttons/js/buttons.print.js')}}"></script>
<script src="{{asset('vendor/datatables/datatables-buttons/js/buttons.html5.js')}}"></script>


<!-- pdfmaker -->
<script src="{{asset('vendor/pdfmake/pdfmake.js')}}"></script>
